...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron text-left">
        ...
        <button id="myButton" type="button" class="btn-belief" data-toggle="collapse" data-target="#Ch1">
            <p>
                Our mission is to present 'All the Gospel for All of Life.'
        In doing so, our focus is Christ, our experience is Pentecostal, and our desire is holiness of life.
            </p>
        </button>
