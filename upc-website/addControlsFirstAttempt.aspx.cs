...
namespace upc_website
{
    public partial class addControlsFirst_Attempt : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //Literal1.Text = "< div id = 'myCarousel' class='carousel carousel slide' data-ride='carousel'>";
            //Literal1.Text = "<image class='img-circle' src='images/1.jpg'/>";
            //Literal1.Text += "<!-- Indicators --><ol class='carousel-indicators'>";
            //Literal1.Text += "<li data-target='#myCarousel' data-slide-to='0' class='active'>";
            //Literal1.Text += "<li data-target='#myCarousel' data-slide-to='1'></li>";
            //Literal1.Text += "<li data-target='#myCarousel' data-slide-to='2'></li>";
            //Literal1.Text += "<li <img src='images/1.jpg'></li>";
            //Literal1.Text += "</o>";
            //Literal1.Text += "</div>";
            ...
            //sb.Append("\n");
            //sb.Append("<image class='img-circle' src='images/1.jpg'/>");
            ...
            StringBuilder sb = new StringBuilder();
            sb.Append("<div style='margin-top:70px;' id ='myCarousel' class='carousel carousel slide' data-ride='carousel'>");
            sb.Append('\n');
