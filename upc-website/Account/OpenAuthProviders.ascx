<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="upc_website.Account.OpenAuthProviders" %>

<div id="socialLoginList">
    <h4>Log in with one of the following:</h4>
    <hr />
