...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron text-center">
        ...
        <p>
            <asp:ImageButton ID="ImageButton5" runat="server" OnClientClick="toggleLiveStreamSlide();"
                OnClick="ImageButton5_Click" ImageUrl="~/images/facebook-streaming.jpg" CssClass="image" />
        </p>
        <p>
