...
<div class="mypage-header text-center">
    ...
    <div class="jumbotron text-center">
        ...
        <p><asp:ImageButton ID="ImageButton1" runat="server" OnClick="ImageButton1_Click" ImageUrl="~/images/sermon stream.png" Width="100%" /></p>
        <p><asp:ImageButton ID="ImageButton2" runat="server" OnClick="ImageButton2_Click" ImageUrl="~/images/sermon archive.png" Width="100%" /></p>
