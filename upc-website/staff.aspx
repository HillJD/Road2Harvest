    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-1 col-sm-5 col-lg-6">
                <img src="images/hurst_342px.jpg" style="border: 2px #666 solid; background-position: 50%;" class="img-rounded">
            </div>
            <div class="col-xs-12 col-sm-1 col-lg-1" style="text-align: left;">
                ...
                <div style="margin-bottom:10px;">Pastor Clifford Hurst has been in the ministry since 1979.   He has served, often concurrently, as
              ...
              the ministry with him.  They have four children and nine grandchildren.</div>
            </div>
        </div>
        <div class="row" style="margin-bottom:10px;">
            <div class="col-xs-1 col-sm-5 col-lg-6">
                <img src="images/mckelvey_342px.jpg" style="border: 2px #666 solid;" class="img-rounded">
            </div>
            <div class="col-xs-12 col-sm-1 col-lg-1" style="text-align: left;">
                ...
                <div style="font-size:18px;font-weight:700;margin:5px 0;">Youth Pastors</div>
                    <div style="margin-bottom:10px;">Pastor Bryan Mckelvey answered the call to preach at the age of 14 and a year later preached his first
              ...
              God and His plans for their life. Bryan and Sarah have three children, Emma, Preston, and Eden.</div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-1 col-sm-5 col-lg-6">
                <img src="images/maggard_342px.jpg" style="border: 2px #666 solid;" class="img-rounded">
            </div>
            <div class="col-xs-12 col-sm-1 col-lg-1" style="text-align: left;">
                ...
                <div style="font-size:18px;font-weight:700;margin:5px 0;">Children's Ministry & Outreach Director</div>
                    <div style="margin-bottom:10px;">Ruth A. Maggard, born in Dayton, Ohio has had a burden for ministry since the age of 8
            ...
            motto is “Partnering with Families to Help Strengthen Today’s Kids”!</div>
                </div>
            </div>
        </div>
    </div>
