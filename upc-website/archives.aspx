...
<div class="mypage-header text-center">
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="SermonAudioID" DataSourceID="SqlDataSource1">
        <Columns>
            ...
            <asp:BoundField DataField="SermonAudioID" HeaderText="SermonAudioID" InsertVisible="False" ReadOnly="True" SortExpression="SermonAudioID" />
            ...
            <asp:BoundField DataField="SermonDt" HeaderText="SermonDt" SortExpression="SermonDt" />
            <asp:BoundField DataField="SermonAMPM" HeaderText="AMPM" SortExpression="AMPM" />
        </Columns>
    </asp:GridView>
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DB_110695_carouselConnectionString %>" SelectCommand="SELECT [SermonAudioID], [Title], [Speaker], [1Book] AS column1, [1Chapter] AS column2, [1VerseStart] AS column3, [1VerseEnd] AS column4, [SermonDt], [SermonAMPM] FROM [SermonAudio] ORDER BY [SermonDt] DESC"></asp:SqlDataSource>
